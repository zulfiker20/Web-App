...
@section('title', $meta_title ?? 'Services - Web App')
@section('content')
    <main>
                    ...
                    @foreach ($services as $service)
                        <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                            <div class="rounded shadow py-5 px-4">
                                <div class="icon"> <i class="{{ $service->icon }}"></i>
                                </div>
                                <h3 class="mb-3">{{ $service->title }}</h3>
                                <p class="mb-4">{{ $service->sub_title }}</p> <a class="btn btn-sm btn-outline-primary"
                                    href="/services/{{ $service->id }}">View
