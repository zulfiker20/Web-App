...
@section('title', $meta_title ?? 'About Us - Web App')
@section('content')
    <main>
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-lg-4 mt-5 mt-lg-0">
                        <img loading="lazy" decoding="async" src="{{ asset($about->image ?? '') }}" class="rounded w-100">
                    </div>
                </div>
            </div>
        </section>
                    ...
                    @foreach ($teams as $team)
                        <div class="col-xl-3 col-lg-4 col-md-6 mt-4">
                            <div class="card bg-transparent border-0 text-center">
                                <div class="card-img">
                                    <img loading="lazy" decoding="async" src="{{ asset($team->image ?? '') }}"
                                        alt="{{ $team->name }}" class="rounded w-100" width="300" height="332">
                                    <ul class="card-social list-inline">
                                        <li class="list-inline-item"><a class="facebook"
                                                href="{{ $team->facebook ?? '' }}"><i class="fab fa-facebook"></i></a>
                                        </li>
                                        <li class="list-inline-item"><a class="twitter" href="{{ $team->twitter ?? '' }}"><i
